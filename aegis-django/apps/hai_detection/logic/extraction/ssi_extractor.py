...
from ..data_models import HAICandidate, ClinicalNote, LLMAuditEntry, SurgicalProcedure
from ..llm.factory import get_llm_client
from ..notes.chunker import NoteChunker
# HAIDatabase removed - Django ORM replaces direct DB access
HAIDatabase = None  # Type stub for compatibility
