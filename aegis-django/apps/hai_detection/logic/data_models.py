...
@dataclass
class NHSNEvent:
    """An NHSN-reportable event (confirmed HAI).

    Created when an HAI candidate is confirmed through classification
    and IP review.
    """
    id: str
    hai_type: HAIType
    ...
    patient_mrn: str
    event_date: datetime
    nhsn_event_type: str  # CLABSI, MBI-LCBI, SSI-superficial, SSI-deep, etc.
    location_code: str | None = None
    reported: bool = False
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "nhsn_event_type": self.nhsn_event_type,
            "location_code": self.location_code,
