...
from ..alert_models import DoseAlertSeverity, DoseFlag, DoseFlagType
...
INDICATION_DOSE_RULES = {
    ...
    "invasive_candidiasis": {
        "fluconazole": {
            "adult": {"loading_dose_mg": 800, "maintenance_dose_mg": 400, "interval": "q24h", "requires_loading": True},
            "pediatric": {"loading_dose_mg_kg": 12, "maintenance_dose_mg_kg": 6, "interval": "q24h", "requires_loading": True},
            "severity": DoseAlertSeverity.HIGH,
    ...
    "invasive_aspergillosis": {
        "voriconazole": {
            "adult": {
                "loading_dose_mg_kg": 6, "maintenance_dose_mg_kg": 4,
                "interval_loading": "q12h", "interval_maintenance": "q12h",
                "requires_tdm": True, "target_trough_mcg_ml": [1.0, 5.5],
            },
            "severity": DoseAlertSeverity.HIGH,
        ...
        "isavuconazole": {
            "adult": {
                "loading_dose_mg": 372, "interval_loading": "q8h", "loading_doses": 6,
                "maintenance_dose_mg": 372, "interval_maintenance": "q24h",
            },
            "severity": DoseAlertSeverity.HIGH,
            "source": "IDSA Aspergillosis Guidelines 2016",
        },
    ...
    "pneumonia": {
        "piperacillin_tazobactam": {
            "adult": {"dose_mg": 4500, "interval": "q6h", "extended_infusion_hours": 4, "recommend_extended": True},
            "severity": DoseAlertSeverity.MODERATE,
            "source": "Time-dependent beta-lactam PK/PD",
            "note": "Consider extended infusion over 4 hours for severe pneumonia",
        },
        "meropenem": {
            "adult": {"dose_mg": 2000, "interval": "q8h", "extended_infusion_hours": 3, "recommend_extended": True},
            "severity": DoseAlertSeverity.MODERATE,
...
class IndicationRules(BaseRuleModule):
    ...
    def evaluate(self, context: PatientContext) -> list[DoseFlag]:
        ...
        for med in context.antimicrobials:
            ...
            flag = self._check_dosing(
                med=med, expected=expected_dosing, drug_rule=drug_rule,
                context=context, age_group=age_group,
            )
            if flag:
                flags.append(flag)
    ...
    def _check_dosing(self, med, expected, drug_rule, context, age_group):
