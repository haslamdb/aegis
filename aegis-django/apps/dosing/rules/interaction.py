...
class DrugInteractionRules(BaseRuleModule):
    ...
    def _drug_matches(self, drug_name, pattern):
    ...
    def _patient_on_interacting_drug(self, co_med_names, interacting_drug):
    ...
    def _format_interacting_drug_list(self, co_med_names, interacting_drug):
        found = []
