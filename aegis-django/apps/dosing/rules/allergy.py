...
class AllergyRules(BaseRuleModule):
    ...
    def _check_direct_match(self, med, allergies, context):
    ...
    def _check_cross_reactivity(self, med, allergies, context):
        flags = []
        drug_lower = med.drug_name.lower()
        ...
        for allergy in allergies:
            ...
            for allergen_class in allergen_classes:
                for drug_class in drug_classes:
                    rule = self._find_cross_reactivity_rule(allergen_class, drug_class)
                    if not rule:
                        continue
    ...
    def _get_drug_classes(self, drug_name):
        classes = []
    ...
    def _find_cross_reactivity_rule(self, allergen_class, drug_class):
