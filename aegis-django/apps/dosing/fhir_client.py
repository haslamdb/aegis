...
Copied from dosing-verification/src/fhir_client.py with Django settings integration.
"""
...
class DosingFHIRClient:
    ...
    def __init__(self, fhir_url: str | None = None):
        self.fhir_url = fhir_url or getattr(settings, 'FHIR_BASE_URL', 'http://localhost:8081/fhir')
    ...
    def build_patient_context(self, patient_mrn: str, indication: str = None) -> PatientContext | None:
        ...
        try:
            ...
            if age_years is not None and age_years < (90 / 365.25):
                try:
                    result = self._get("Observation", {
                        "patient": patient_id,
                        "code": "11884-4",
