...
def get_fhir_client() -> FHIRClient:
    """Factory function - returns appropriate client based on Django settings."""
    epic_url = getattr(settings, 'EPIC_FHIR_BASE_URL', None)
    epic_client_id = getattr(settings, 'EPIC_CLIENT_ID', None)
